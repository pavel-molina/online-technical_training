...
url = 'https://pavel-molina-online-technical-training-dev-academy-2454130.dev.odoo.com'
db = 'pavel-molina-online-technical-training-dev-academy-2454130'
username = 'admin'
password = 'admin'
...
new_session = models.execute_kw(db, uid, password, 'academy.session', 'create',
                                [
                                    {'course_id': course[0], 'state': 'open', 'duration': 5}
                                ]
                               )
print(new_session)